...
This function will return the power for specified sample size and other model parameters for estimating association between a genetic variant and a binary outcome from a case-control model:
